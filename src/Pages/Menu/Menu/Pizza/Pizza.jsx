...
const Pizza = () => {
    ...
    useEffect((()=>{
        ...
        setPizzaItem(pizzaItems.slice(0,6))
    }),[])
    return (
        <div className='mt-10'>
            
<Cover img={Pizzas} title='PIZZA' des='Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.'>

</Cover>
<div className='px-0 lg:px-14'>
<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7'>
    {
        pizzaItem?.map(item =><div className=''>
